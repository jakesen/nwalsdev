...
if os.environ.has_key('DATABASE_URL'):
    ...
    EMAIL_PORT = 587
    EMAIL_USE_TLS = True
    DEFAULT_FROM_EMAIL = "Northwest Alabama Software Developers <"+EMAIL_HOST_USER+">"
else:
    DEBUG = True
...
SECRET_KEY = "y4^q1cr!maz9bymovuoxqsxdhmlqkjj+l^p&_jqesth7ptu+u_"
...
ROOT_URLCONF = "nwalsdev.urls"

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = "nwalsdev.wsgi.application"
